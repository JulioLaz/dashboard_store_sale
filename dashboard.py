...
#### metric with indicator
    ...
    def dashboard_metrics(filtered_df):
        ...
        col1.markdown("<span style='color: #00ff00;font-size:1.2rem'>Total de Ventas</span>", unsafe_allow_html=True)
        ...
        col2.markdown("<span style='color: #00ff00;font-size:1.2rem'>Ganancia Neta</span>", unsafe_allow_html=True)
        ...
        col3.markdown("<span style='color: #00ff00;font-size:1.2rem'>Número de Pedidos</span>", unsafe_allow_html=True)
        ...
        col4.markdown("<span style='color: #00ff00;font-size:1.2rem'>Marcas</span>", unsafe_allow_html=True)
        ...
        col5.markdown("<span style='color: #00ff00;font-size:1.2rem'>Productos</span>", unsafe_allow_html=True)
